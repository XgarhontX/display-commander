...
void ImGuiWrapperStandalone::TextUnformatted(const char* text) { ImGui::TextUnformatted(text); }
bool ImGuiWrapperStandalone::Button(const char* label) { return ImGui::Button(label); }
bool ImGuiWrapperStandalone::Button(const char* label, const ImVec2& size) { return ImGui::Button(label, size); }
bool ImGuiWrapperStandalone::SmallButton(const char* label) { return ImGui::SmallButton(label); }
bool ImGuiWrapperStandalone::Checkbox(const char* label, bool* v) { return ImGui::Checkbox(label, v); }
bool ImGuiWrapperStandalone::IsItemHovered() { return ImGui::IsItemHovered(); }
bool ImGuiWrapperStandalone::IsItemActive() { return ImGui::IsItemActive(); }
bool ImGuiWrapperStandalone::IsItemDeactivatedAfterEdit() { return ImGui::IsItemDeactivatedAfterEdit(); }
...
void ImGuiWrapperStandalone::SetTooltipExV(float wrap_width, const char* fmt, va_list args) {
    ImGui::BeginTooltip();
...
void ImGuiWrapperStandalone::Spacing() { ImGui::Spacing(); }
void ImGuiWrapperStandalone::Separator() { ImGui::Separator(); }
...
void ImGuiWrapperStandalone::EndChild() { ImGui::EndChild(); }
...
bool ImGuiWrapperStandalone::BeginTable(const char* str_id, int columns, int flags, const ImVec2& outer_size) {
    return ImGui::BeginTable(str_id, columns, static_cast<ImGuiTableFlags>(flags), outer_size);
}
void ImGuiWrapperStandalone::EndTable() { ImGui::EndTable(); }
...
void ImGuiWrapperStandalone::TableSetupScrollFreeze(int cols, int rows) { ImGui::TableSetupScrollFreeze(cols, rows); }
void ImGuiWrapperStandalone::TableHeadersRow() { ImGui::TableHeadersRow(); }
void ImGuiWrapperStandalone::TableNextRow() { ImGui::TableNextRow(); }
void ImGuiWrapperStandalone::TableNextColumn() { ImGui::TableNextColumn(); }
void ImGuiWrapperStandalone::TableSetColumnIndex(int column_n) { ImGui::TableSetColumnIndex(column_n); }
...
void ImGuiWrapperStandalone::EndCombo() { ImGui::EndCombo(); }
bool ImGuiWrapperStandalone::Selectable(const char* label, bool selected) { return ImGui::Selectable(label, selected); }
void ImGuiWrapperStandalone::SetItemDefaultFocus() { ImGui::SetItemDefaultFocus(); }
void ImGuiWrapperStandalone::PushID(int id) { ImGui::PushID(id); }
void ImGuiWrapperStandalone::PushID(const char* str_id) { ImGui::PushID(str_id); }
void ImGuiWrapperStandalone::PopID() { ImGui::PopID(); }
void ImGuiWrapperStandalone::Indent() { ImGui::Indent(); }
void ImGuiWrapperStandalone::Unindent() { ImGui::Unindent(); }
...
void ImGuiWrapperStandalone::PopStyleColor(int count) { ImGui::PopStyleColor(count); }
...
bool ImGuiWrapperStandalone::TreeNode(const char* label) { return ImGui::TreeNode(label); }
void ImGuiWrapperStandalone::TreePop() { ImGui::TreePop(); }
ImVec2 ImGuiWrapperStandalone::GetContentRegionAvail() { return ImGui::GetContentRegionAvail(); }
float ImGuiWrapperStandalone::GetStyleItemSpacingX() { return ImGui::GetStyle().ItemSpacing.x; }
float ImGuiWrapperStandalone::GetStyleFramePaddingX() { return ImGui::GetStyle().FramePadding.x; }
ImVec2 ImGuiWrapperStandalone::CalcTextSize(const char* text) { return ImGui::CalcTextSize(text); }
void ImGuiWrapperStandalone::SetNextItemWidth(float width) { ImGui::SetNextItemWidth(width); }
void ImGuiWrapperStandalone::BeginDisabled() { ImGui::BeginDisabled(); }
void ImGuiWrapperStandalone::EndDisabled() { ImGui::EndDisabled(); }
...
bool ImGuiWrapperStandalone::Combo(const char* label, int* current_item, const char* const items[], int items_count) {
...
void ImDrawListProxyStandalone::AddRect(const ImVec2& p_min, const ImVec2& p_max, ImU32 col, float rounding, int flags,
                                        float thickness) {
    if (list_) list_->AddRect(p_min, p_max, col, rounding, static_cast<ImDrawFlags>(flags), thickness);
}
void ImDrawListProxyStandalone::AddRectFilled(const ImVec2& p_min, const ImVec2& p_max, ImU32 col, float rounding,
                                              int flags) {
...
ImVec2 ImGuiWrapperStandalone::GetCursorScreenPos() { return ImGui::GetCursorScreenPos(); }
void ImGuiWrapperStandalone::SetCursorScreenPos(const ImVec2& pos) { ImGui::SetCursorScreenPos(pos); }
float ImGuiWrapperStandalone::GetCursorPosX() { return ImGui::GetCursorPosX(); }
void ImGuiWrapperStandalone::Dummy(const ImVec2& size) { ImGui::Dummy(size); }
ImVec2 ImGuiWrapperStandalone::GetItemRectMin() { return ImGui::GetItemRectMin(); }
ImVec2 ImGuiWrapperStandalone::GetItemRectSize() { return ImGui::GetItemRectSize(); }
void ImGuiWrapperStandalone::ProgressBar(float fraction, const ImVec2& size_arg, const char* overlay) {
    ImGui::ProgressBar(fraction, size_arg, overlay);
}
ImU32 ImGuiWrapperStandalone::GetColorU32(int col_enum) { return ImGui::GetColorU32(static_cast<ImGuiCol>(col_enum)); }
ImU32 ImGuiWrapperStandalone::ColorConvertFloat4ToU32(const ImVec4& col) { return ImGui::ColorConvertFloat4ToU32(col); }
bool ImGuiWrapperStandalone::SliderFloat(const char* label, float* v, float v_min, float v_max, const char* format) {
    return ImGui::SliderFloat(label, v, v_min, v_max, format);
}
void ImGuiWrapperStandalone::Columns(int count, const char* id, bool border) { ImGui::Columns(count, id, border); }
void ImGuiWrapperStandalone::NextColumn() { ImGui::NextColumn(); }

void ImGuiWrapperStandalone::SetColumnWidth(int column_index, float width) {
    ImGui::SetColumnWidth(column_index, width);
}
void ImGuiWrapperStandalone::BeginTooltip() { ImGui::BeginTooltip(); }
void ImGuiWrapperStandalone::EndTooltip() { ImGui::EndTooltip(); }
...
void ImGuiWrapperStandalone::BeginGroup() { ImGui::BeginGroup(); }
void ImGuiWrapperStandalone::EndGroup() { ImGui::EndGroup(); }
const ImGuiStyle& ImGuiWrapperStandalone::GetStyle() { return ImGui::GetStyle(); }
...
void ImGuiWrapperStandalone::End() { ImGui::End(); }
...
void ImGuiWrapperStandalone::EndTabItem() { ImGui::EndTabItem(); }
void ImGuiWrapperStandalone::EndTabBar() { ImGui::EndTabBar(); }
bool ImGuiWrapperStandalone::IsKeyDown(int key) { return ImGui::IsKeyDown(static_cast<ImGuiKey>(key)); }
bool ImGuiWrapperStandalone::IsKeyPressed(int key) { return ImGui::IsKeyPressed(static_cast<ImGuiKey>(key)); }
void ImGuiWrapperStandalone::SetKeyboardFocusHere(int offset) { ImGui::SetKeyboardFocusHere(offset); }
void ImGuiWrapperStandalone::OpenPopup(const char* str_id) { ImGui::OpenPopup(str_id); }
...
void ImGuiWrapperStandalone::EndPopup() { ImGui::EndPopup(); }
