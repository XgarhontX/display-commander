...
void DrawMainNewTab(display_commander::ui::GraphicsApi api, display_commander::ui::IImGuiWrapper& imgui,
    ...
    const bool megamix_open = imgui.CollapsingHeader("Megamix", ImGuiTreeNodeFlags_DefaultOpen);
    ...
    if (megamix_open) {
        ...
        imgui.TextColored(ui::colors::TEXT_LABEL, "- Obviously, don't use alongside High Frame Rate mod!");
