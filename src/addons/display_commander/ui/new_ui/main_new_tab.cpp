...
static void DrawMainTabOptionalPanelsAdvancedSettingsUi(display_commander::ui::IImGuiWrapper& imgui) {
    ...
    if (imgui.IsItemHovered()) {
        imgui.SetTooltipEx(
            "DLSS / DLSS-G / RR status, preset overrides, DLL overrides, registry indicator, and related controls "
            "(moved out of Display Settings).");
    }
...
static void DrawMainTabOptionalPanelDlssControl(display_commander::ui::GraphicsApi api,
...
static void DrawMainTabOptionalPanelDxgiControl(display_commander::ui::GraphicsApi api,
                                                display_commander::ui::IImGuiWrapper& imgui);
