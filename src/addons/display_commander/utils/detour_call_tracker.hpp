...
// Maximum number of distinct detour call sites (one entry per CALL_GUARD site)
...
// crash report. Thread-safe. Use DETOUR_SET_CONTEXT_AT(line, fmt, ...) with the line number of CALL_GUARD.
...
#define CALL_GUARD(timestamp_ns)                                                                    \
