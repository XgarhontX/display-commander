...
AdvancedTabSettings::AdvancedTabSettings()
    : continue_rendering("ContinueRendering", false, "DisplayCommander"),
      ...
      block_gameoverlayrenderer("BlockGameOverlayRenderer", false, "DisplayCommander"),
      ...
      auto_enable_reshade_config_backup("auto_reshade_config_backup", false, "DisplayCommander"),
