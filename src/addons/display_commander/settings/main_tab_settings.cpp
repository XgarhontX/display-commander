...
MainTabSettings::MainTabSettings()
    : window_mode(
      ...
      show_notes_tab("show_notes_tab", false, "DisplayCommander"),
      show_nvidia_profile_tab("show_nvidia_profile_tab", false, "DisplayCommander"),
      show_main_tab_dc_folders("show_main_tab_dc_folders", false, "DisplayCommander"),
      show_main_tab_brightness_autohdr("show_main_tab_brightness_autohdr", false, "DisplayCommander"),
      ...
      show_main_tab_cpu_control("show_main_tab_cpu_control", false, "DisplayCommander"),
      ...
      license_acknowledged_version("license_acknowledged_version", 0, 0, 999999999, "DisplayCommander"),
    ...
    all_settings_ = {
        ...
        &show_vulkan_tab,
        &show_notes_tab,
        &show_nvidia_profile_tab,
        &show_main_tab_dc_folders,
        &show_main_tab_brightness_autohdr,
        &show_main_tab_texture_filtering,
        &show_main_tab_audio_control,
        &show_main_tab_cpu_control,
