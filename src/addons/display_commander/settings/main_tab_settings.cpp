...
MainTabSettings::MainTabSettings()
    : window_mode(
      ...
      show_actual_refresh_rate("show_actual_refresh_rate_def_off", false, "DisplayCommander"),
      ...
      show_refresh_rate_frame_times("show_refresh_rate_frame_times_def_off", false, "DisplayCommander"),
      ...
      show_nvapi_latency_stats("show_nvapi_latency_stats", false, "DisplayCommander"),
