...
MainTabSettings::MainTabSettings()
    : window_mode(
      ...
      onpresent_reflex_mode("onpresent_reflex_mode", static_cast<int>(OnPresentReflexMode::kLowLatency),
                            {"Low latency", "Low Latency + boost (can cause issues)", "Off", "Game Defaults"}, "DisplayCommander"),
      ...
      show_vrr_status("show_vrr_status_def_off", false, "DisplayCommander"),
      vrr_debug_mode("vrr_debug_mode_def_off", false, "DisplayCommander"),
      ...
      show_overlay_cpu_process_load("show_overlay_cpu_process_load", false, "DisplayCommander"),
      show_overlay_cpu_system_load("show_overlay_cpu_system_load", false, "DisplayCommander"),
      show_overlay_nvapi_gpu_util("show_overlay_nvapi_gpu_util", false, "DisplayCommander"),
      show_overlay_nvapi_gpu_temp("show_overlay_nvapi_gpu_temp", false, "DisplayCommander"),
      show_nvapi_latency_stats("show_nvapi_latency_stats", true, "DisplayCommander"),
      ...
      show_overlay_nvapi_latency_jitter_abs("show_overlay_nvapi_latency_jitter_abs", true, "DisplayCommander"),
      ...
      show_overlay_ram("show_overlay_ram", false, "DisplayCommander"),
      overlay_background_alpha("overlay_background_alpha", 0.6f, 0.0f, 1.0f, "DisplayCommander"),
      overlay_chart_alpha("overlay_chart_alpha", 0.0f, 0.0f, 1.0f, "DisplayCommander"),
      overlay_graph_scale("overlay_graph_scale", 2.0f, 0.5f, 10.0f, "DisplayCommander"),
      ...
      show_main_tab_texture_filtering("show_main_tab_texture_filtering", false, "DisplayCommander"),
      show_main_tab_audio_control("show_main_tab_audio_control", false, "DisplayCommander"),
      show_main_tab_window_action_buttons("show_main_tab_window_action_buttons", false, "DisplayCommander"),
    ...
    all_settings_ = {
        ...
        &show_cpu_usage,
        &show_overlay_cpu_process_load,
        &show_overlay_cpu_system_load,
        &show_overlay_nvapi_gpu_util,
        &show_overlay_nvapi_gpu_temp,
        &show_nvapi_latency_stats,
        ...
        &show_controller_tab,
        &show_reshade_tab,
        &show_main_tab_texture_filtering,
        &show_main_tab_audio_control,
        &show_main_tab_window_action_buttons,
