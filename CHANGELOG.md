...
- [ui] [settings] **Games and Hotkeys tab checkboxes** - Main → Show Individual Tabs now includes "Show Games Tab" and "Show Hotkeys Tab". Both default to on so behavior is unchanged unless you uncheck them. Standalone settings window respects these settings. Details: main_tab_settings show_games_tab, show_hotkeys_tab (default true); new_ui_tabs gates Games and Hotkeys visibility; cli_standalone_ui.cpp.
